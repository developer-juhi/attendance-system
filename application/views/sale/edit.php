...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                <form name="editsale" id="editsale"  method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group label-floating is-empty">
                                        <label class="control-label"></label>
                                        <input class="form-control" type="text" value="<?php echo $data['total_sale']; ?>"
                                        id="total_sale" name="total_sale" placeholder="Total Sale">
                                    </div>
                                </div>
                            </div>
