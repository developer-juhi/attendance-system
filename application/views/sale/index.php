                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="material-datatables">
                            <table id="sale_list" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                <thead>
                                    <tr>
                                    <th>No</th>
                                    <th>Company Name</th>                                   
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?php echo base_url('sale-update?id='.$data['id']);?>" type="button" name="update" id="" class="btn btn-simple btn-warning btn-icon edit"> 
